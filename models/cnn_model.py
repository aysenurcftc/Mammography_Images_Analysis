...
from visualisation.plots import plot_roc_curve_binary, plot_roc_curve_multiclass
...
class CnnModel:
    ...
    def save_model(self):
        ...
        if config.model == "MobileNet":
            ...
            self._model.save("/Users/aysen/OneDrive/Masaüstü/Breast_Cancer_Detection/saved_model/dataset-{}_model-{}_saved-model.h5".format(
                config.dataset,
                config.model))
    ...
    def save_weights(self):
        ...
        if config.model == "vit":
            self._model.save_weights(f"/Users/aysen/OneDrive/Masaüstü/Breast_Cancer_Detection/saved_model/dataset-{config.dataset}_mammogramtype-{config.mammogram_type}_model-{config.model}_all_weights")
